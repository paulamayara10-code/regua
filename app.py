...
if page == "Upload diário":
    ...
    st.caption("Use a URL raw do arquivo XLSX salvo no GitHub para iniciar ou recuperar a base do dia. Depois, quando quiser, faça o upload manual abaixo para substituir/processar o relatório atual.")
